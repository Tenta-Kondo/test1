...
Route::post('/blog/update/{id}', 'App\Http\Controllers\BlogController@exeUpdate')->name("update");
Route::get('/blog/{id}', 'App\Http\Controllers\BlogController@showDetail')->name("show");
Route::get('/blog/delete/{id}', 'App\Http\Controllers\BlogController@exeDelete')->name("delete");